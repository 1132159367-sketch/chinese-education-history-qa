...
Slide: 04 of 12
Filename: 04-slide-faraday-law.png
Type: Content

Narrative Goal:
Present Faraday's law with mathematical rigor and expert-level understanding.

Key Content:
Headline: 法拉第电磁感应定律
Sub-headline: 感应电动势与磁通量变化率的关系
Body:
- 法拉第定律：E = -n(dΦ/dt)
- n: 线圈匝数，负号表示楞次定律方向
- 物理意义：感应电动势大小与磁通量变化率成正比

Visual Description:
Mathematical formula E = -n(dΦ/dt) displayed in large hand-written font. Graph showing magnetic flux vs time curve with slope representing dΦ/dt. Coil with N turns illustration. Direction indicators with arrows. Key variables (n, Φ, t) color-coded with palette accents.

Layout: formula-focus
Large formula as central element, with supporting diagrams and explanatory text arranged around it in balanced layout.
