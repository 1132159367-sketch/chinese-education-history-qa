...
Slide: 05 of 12
Filename: 05-slide-lenz-law.png
Type: Content
...
Visual Description:
Hand-drawn coil with magnet approaching. Two scenarios: magnet approaching vs magnet receding. Magnetic field lines shown with different colors for original field and induced field. Hand-drawn arrows showing "opposes change" relationship. Energy conservation formula displayed: ΔEmechanical = ΔEelectrical.

Layout: comparison-two-column
Two scenarios side by side with clear visual distinction. Central statement summarizing Lenz's law in bold handwritten text.
