...
Narrative Goal:
Introduce the topic of electromagnetic induction with visual impact and establish technical credibility.

Key Content:
Headline: 电磁感应 Electromagnetic Induction
Sub-headline: 高中物理核心概念解析

Visual Description:
Large hand-drawn title with bold marker font. Background shows subtle coil and magnet doodle in light gray or accent color. Small decorative elements like stars, arrows indicating magnetic field direction. Warm, inviting atmosphere with professional depth.

Layout: title-hero
Center-aligned title with visual elements radiating outward, creating dynamic flow while maintaining focus on the main topic.
